...
const translations: Record<Language, Record<string, string>> = {
  ja: {
    ...
    "bill-split.assign.instruction":
      "各顔画像をタップして名前を割り当ててください",
    ...
    "error.file.format":
      "対応していないファイル形式です。{formats}形式のファイルを選択してください。",
    "error.file.size":
      "ファイルサイズが大きすぎます。10MB以下のファイルを選択してください。",
    "error.resolution":
      "画像の解像度が低すぎます。200x200ピクセル以上の画像を選択してください。",
    ...
    "share.app-link": "🔗 https://pizza-divider.vercel.app/",
    ...
    "roulette.pizza.description.photo":
    ...
    // Share messages
    "share.success.mobile":
      "📱 文言をコピーし、画像をダウンロードしました！\n\n1. Slackに文言を貼り付け\n2. 画像を添付してください",
    "share.success.image-download":
      "📱 画像をダウンロードしました！\n\n以下の文言をコピーしてSlackに投稿してください：\n\n{message}",
    "share.success.clipboard":
      "💻 画像と文言をクリップボードにコピーしました！\nSlackに貼り付けてください。",
    "share.success.text-image":
      "💻 文言をコピーし、画像をダウンロードしました！\n両方をSlackに投稿してください。",
  ...
  en: {
    ...
    "evaluate.description":
      "Take a photo of the cut pizza to evaluate accuracy",
    ...
    "error.file.format":
      "Unsupported file format. Please select {formats} format.",
    "error.file.size": "File too large. Please select file under 10MB.",
    "error.resolution":
      "Image resolution too low. Please select image over 200x200 pixels.",
    ...
    "split-bill.description":
      "Calculated based on satisfaction from facial expressions",
    ...
    "split-bill.calculation.desc2":
      "Pay for how much you enjoyed it - fair split!",
    "split-bill.button.complete": "Complete",
    "split-bill.button.back": "Back",

    // Share messages
    "share.success.mobile":
      "📱 Text copied and image downloaded!\n\n1. Paste text in Slack\n2. Attach the image",
    "share.success.image-download":
